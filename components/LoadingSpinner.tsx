...
const messages = [
    "Consultando gli spiriti dei detective...",
    "Scrivendo la trama del mistero...",
    "Piantando indizi fuorvianti...",
    "Affilando i coltelli... metaforicamente!",
    "Preparando gli alibi...",
    "Un detective IA sta verificando gli indizi...",
    "Controllando la coerenza della trama...",
    "Orchestrando il colpo di scena finale..."
];
